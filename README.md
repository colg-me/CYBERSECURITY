...
Malware Analysis : Static and dynamic analysis of malicious samples in isolated environments.
Tools & Scripts : Custom utilities developed to automate security tasks and support offensive/defensive operations.
CTF & Writeups : Solutions and detailed writeups for Capture The Flag challenges from various platforms.
